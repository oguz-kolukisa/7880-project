#!/bin/bash
# Training script for Pascal-5i with ResNet101
...
HF_TOKEN=""  # Set your Hugging Face token here or use environment variable
...
echo "======================================"
echo "Pascal-5i + ResNet101 Training"
echo "======================================"
...
echo "======================================"
echo "Pascal-5i + ResNet101 Complete!"
echo "======================================"
